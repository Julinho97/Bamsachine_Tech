...
<html>
<head>
	<title>Bamsachine Tech - Insciption</title>
	<meta charset="utf-8"/>
...
<body>
	...
	?>
	<div id="corpsSignIn">
		<h2>Bamsachine Tech</h2>
		<h4>Créér votre compte Bamsachine Tech</h4>
		<form id="fSignIn" action="" method="post" align="center">
			...
			<input type="text" required placeholder="Numéro de téléphon" maxlength="10" name="num_tel" class="input" id="numTel" title="Numéro de téléphone(SN (+221))"/>
