<header class="entete">         
     <nav class="menu">       
         <ul>
             ...
             <li class="dropdown" id="nAnnonce">
                 <a href="dashboard.php" class="dropbtn"><?php if(isset($prenoms)){
                 ...
                 <div class="elementListe">
                 <?php if (isset($_COOKIE['__lingoser']) AND $userInfo['id_user'] == $_COOKIE['__lingoser']){?>
                    <a href="profil.php">Profil</a>
                    <a href="
                    deconnexion.php">Deconnexion</a>
                <?php } ?>    
                </div>
             </li>
